# Unity Mobile Reference Game with Huawei Mobile Services Plugin AdsKit, AccountKit, IAP and Game Services

Maze Game is a game that you need to complete the maze without failing to achieve next level.
